...
public final class TransferConfig {
    ...
    public void setPosition(int nowThumbnailIndex) {
    ...
    public static class Builder {
        ...
        private boolean enableHideThumb = false;
         ...
         */
        public Builder setListData(List<String> sourceUrlList) {
            this.sourceUrlList = sourceUrlList;
            return this;
        }
        ...
        public TransferConfig create() {
            ...
            config.setPosition(nowThumbnailIndex);
