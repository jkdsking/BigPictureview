...
public class Transferee implements DialogInterface.OnShowListener,
    ...
    /**
     * 构造方法私有化，通过{@link #(Context)} 创建 transferee
     *
     * @param context 上下文环境
     */
     ...
     */
    public static Transferee init(Context context) {
    ...
    private void checkConfig() {
        ...
        transConfig.setPosition(Math.max(transConfig.getNowThumbnailIndex(), 0));
        ...
        if (transConfig.getIndexIndicator()==null){
            transConfig.setIndexIndicator(null);
        }else {
